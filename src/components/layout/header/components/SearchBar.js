...
const SearchBar = () => {
  return (
    <form
      method='GET'
      className='search-bar flex-row flex-grow justify-start flex-nowrap'
    >
      <input
        className='search-bar__field flex-grow'
        type='text'
        placeholder='Que souhaitez-vous apprendre ?'
      />
      <Button className='btn--primary btn--sm btn--sr-right' type='submit'>
        <svg
          width='16px'
          height='16px'
          viewBox='0 0 16 16'
